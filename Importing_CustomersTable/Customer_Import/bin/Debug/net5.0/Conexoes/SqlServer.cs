...
namespace ImportacaoClientes.Conexoes
{
    public class SqlServer
    {
        ...
        public SqlServer()
        {
            string stringConexao = File.ReadAllText("C:\\Users\\cirof\\Desktop\\RUMO Academy\\RUMO Solucoes - Credenciais\\Tabela Clientes\\StringConexao_aluno.txt");
